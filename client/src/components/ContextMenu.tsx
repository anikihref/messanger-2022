...
const ContextMenu : React.FC<ContextMenuProps> = ({children, customClassName, isVisible, arrowDirection = 'top'}) => {
  ...
  function getPosition(): [TailwindClass, TailwindClass] {
    switch(arrowDirection) {
      ...
      case 'bottom': {
        return [
          'left-1/2 bottom-0 translate-y-full -translate-x-1/2', 
  ...
  return (
    <div className={`absolute z-[100] duration-500 min-w-[200px] bg-blue-100 max-w-[550px] w-fit ${getPosition()[1]} ${customClassName || ''} ${isVisible ? 'opacity-100 visible' : 'invisible opacity-0'}`}>
